            ...
            decimal tien)
        {
            ...
            using (SqlTransaction tx = cn.BeginTransaction())
            {
                try
                {
                    ...
                    SqlCommand paid = new SqlCommand(
                    ...
                    // Nếu trả đủ -> hóa đơn đã thanh toán
                    if (da + tien == tong)
                    {
            ...
            using (SqlTransaction tx = cn.BeginTransaction())
            {
                try
                {
                           ...
                           q.ExecuteReader())
                    {
                        ...
                        soHD =
                            Convert.ToString(rd["SoHoaDon"]);

                        trangThai =
                            Convert.ToString(rd["TrangThai"]);
                    }

                    // Chưa trả đủ -> không được checkout
